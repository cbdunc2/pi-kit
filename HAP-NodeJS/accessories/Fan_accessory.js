...
var FAKE_OUTLET = {
    ...
    if (on) {
          ...
          PythonShell.run('Switch2_1.py', function (err) {
          console.log("...outlet is now on.");          
    });
    } else {
          FAKE_OUTLET.powerOn = false;
          if(err) { return console.log(err); }
          PythonShell.run('Switch2_0.py', function (err) {
...
var outletUUID = uuid.generate('hap-nodejs:accessories:Fan');

// This is the Accessory that we'll return to HAP-NodeJS that represents our fake light.
var outlet = exports.accessory = new Accessory('Outlet', outletUUID);

// Add properties for publishing (in case we're using Core.js and not BridgedCore.js)
outlet.username = "26:DB:20:24:8D:7A";
outlet.pincode = "031-45-153";
...
outlet
  .addService(Service.Outlet, "Lamp") // services exposed to the user should have "names" like "Fake Light" for us
